...
Working reference implementations live in this skill's `scripts/` (curate.py, cut_smart.py, caption.py) and are the canonical versions; the copies in `~/podcast-clips/` are working copies.
